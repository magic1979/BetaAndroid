...
function onDeviceReady() {
	...
	if(connectionStatus=='online'){
		...
		$("#noconn").html(tabella);
						  ...
						  $.ajax({
								 type:"GET",
								 url:"http://gtechplay.com/mirage/www/check_acquistati.asp",
								 contentType: "application/json",
								 data: {id:prod,OP:1},
								 jsonp: 'callback',
								 crossDomain: true,
...
function gofacebook(){
	var ref = window.open('https://m.facebook.com/mirage-1396958183922266', '_system', 'location=no');
}
