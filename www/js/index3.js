		...
		$("#noconn").html(tabella);
						  ...
						  $.ajax({
								 ...
								 $.each(result, function(i,item){
										...
										$("#getting-started").countdown("2016/"+ item.MeseScadenza +"/"+ item.GiornoScadenza +" "+ OraScadenza +":"+ MinutiScadenza +":00", function(event) {
																		$(this).html(event.strftime('%D giorni %H:%M:%S'));
																		});
						  ...
						  $.ajax({
								 type:"GET",
								 url:"http://msop.it/prolutionapp/www/check_acquistati.asp",
								 contentType: "application/json",
								 data: {id:prod,OP:1},
								 jsonp: 'callback',
								 crossDomain: true,
