...
function LoginVera(email,pin){
	...
	$.ajax({
		   type:"GET",
		   url:"http://www.gtechplay.com/vogliadipizza2/www/check_login.asp",
...
function iscriviti(){
	...
	$.ajax({
		   type:"GET",
		   url:"http://www.gtechplay.com/vogliadipizza2/www/Check_Reg.asp",
		   contentType: "application/json",
...
function onPrompt(results) {
	if(results.buttonIndex==1){
		...
		$.ajax({
			   type:"GET",
			   url:"http://www.gtechplay.com/vogliadipizza2/www/Check_RecPassword.asp",
			   contentType: "application/json",
