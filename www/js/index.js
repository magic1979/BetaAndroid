...
var app = {
    ...
    // Update DOM on a Received Event  56d423a4177959c80e8b4567  648839823182
    receivedEvent: function(id) {
		
	    if(PushbotsPlugin.isiOS()){
			PushbotsPlugin.initializeiOS("56d423a4177959c80e8b4567");
		 }
		 if(PushbotsPlugin.isAndroid()){
			PushbotsPlugin.initializeAndroid("56d423a4177959c80e8b4567", "843188688431");
		 }
...
function buildprodotto(Categoria,Provincia,Pagina) {
	...
	$.ajax({
		   type:"GET",
		   url:"http://msop.it/puntoincontro/www/Check_Home.asp",
		   contentType: "application/json",
		   ...
		   $.each(result, function(i,item){
				if (item.ID != 0){
				  ...
				  if (model.indexOf('iPad') >= 0) {
					...
					landmark2 = landmark2 + "<div id="+ item.Cod_Prodotto +"'><a style='text-decoration: none;' href='index3.html?prod="+ item.Cod_Prodotto +"' rel='external' onclick='#' data-transition='slide' id='linkdettagli"+ item.Cod_Prodotto +"'><img src='http://msop.it/public/puntoincontro/"+ item.IMG +".png' width='100%'><table height='30px' border='0' width='320px'><tr><td align='left' colspan='2'><font size='3' color='#454545'>"+ item.Descrizione +"</font></td></tr><tr><td align='left' width='160px'><br><font size='2' color='#454545'>Acquistati:</font><font size='2' color='#B40431'> "+ item.Acquistati +"</font></td><td align='right'><br><font size='2' color='#B40431'>Vale:<strike>"+ item.Valore +"&euro;</strike> "+ item.Sconto +"%</font></font></td></tr><tr><td align='left' width='160px' valign='center'><font size='2' color='#454545'>Scade tra: </font><font size='2' color='#B40431'>"+ item.GiorniRimanenti +" </font><font size='2' color='#454545'>giorni</font></td><td id='deallo"+ item.Cod_Prodotto +"' colspan='2' align='right'><font size='5' color='#B40431'>"+ item.Deal +"&euro;</font></td></tr><tr id='vis2"+ item.Cod_Prodotto +"' style='display:none' class='visione'><td align='left' colspan='2'><font size='1' color='#454545' class='someclass'>"+ item.Dettagli +"</font></td></tr></table></a><br><hr class='div3'></div>";
				  }
...
function RegToken(){
	//alert("entrato2")
		...
		$.ajax({
			   type:"GET",
			   url:"http://msop.it/puntoincontro/www/Check_RegToken.asp",
			   contentType: "application/json",
